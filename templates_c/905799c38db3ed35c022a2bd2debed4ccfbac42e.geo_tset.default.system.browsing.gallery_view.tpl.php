<?php /* Smarty version Smarty-3.1.19, created on 2022-05-14 23:44:57
         compiled from "geo_tset:default:system:browsing:common/gallery_view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:33131034362803ef9474b16-10287704%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '905799c38db3ed35c022a2bd2debed4ccfbac42e' => 
    array (
      0 => 'geo_tset:default:system:browsing:common/gallery_view.tpl',
      1 => 1635622234,
      2 => 'geo_tset',
    ),
  ),
  'nocache_hash' => '33131034362803ef9474b16-10287704',
  'function' => 
  array (
  ),
  'variables' => 
  array (
    ...
    'no_listings' => 0,
    'listings' => 0,
    'main_page_gallery_sub_template' => 0,
    'listing' => 0,
    'cfg' => 0,
    'id' => 0,
    'headers' => 0,
  ...
  'unifunc' => 'content_62803ef9512811_29540077',
),false); /*/%%SmartyHeaderCode%%*/?><?php $_smarty_tpl->used_tags = array (
  'include' => 
  array (
    '$_smarty_tpl->tpl_vars[\'main_page_gallery_sub_template\']->value:main_page:' => 
    array (
      'file' => '$_smarty_tpl->tpl_vars[\'main_page_gallery_sub_template\']->value',
      'g_type' => 'main_page',
      'g_resource' => '',
    ),
...
<?php if ($_valid && !is_callable('content_62803ef9512811_29540077')) {function content_62803ef9512811_29540077($_smarty_tpl) {?><?php if (!is_callable('smarty_function_listing')) include '/Users/lauropimentel/Projects/eucompro/classes/geo_smarty_plugins/function.listing.php';
...
?>
<?php if (!$_smarty_tpl->tpl_vars['gallery_columns']->value) {?>
	<?php $_smarty_tpl->tpl_vars['gallery_columns'] = new Smarty_variable(1, null, 0);?>
<?php }?>
...
?>
				<?php if ($_smarty_tpl->tpl_vars['gallery_columns']->value&&$_smarty_tpl->tpl_vars['listing']->index%$_smarty_tpl->tpl_vars['gallery_columns']->value==0) {?><div class="gallery_row"><?php }?>
				
				<?php if ($_smarty_tpl->tpl_vars['main_page_gallery_sub_template']->value) {?>
					<?php echo $_smarty_tpl->getSubTemplate ($_smarty_tpl->tpl_vars['main_page_gallery_sub_template']->value, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('g_type'=>'main_page','g_resource'=>''), 0);?>

				<?php } else { ?>
					<article class="listing columns-<?php echo $_smarty_tpl->tpl_vars['gallery_columns']->value;?>
">
						<div class="article_inner <?php echo $_smarty_tpl->tpl_vars['listing']->value['css'];?>
">
...
><?php echo $_smarty_tpl->tpl_vars['listing']->value['title'];?>
									...
									<?php if ($_smarty_tpl->tpl_vars['listing']->value['icons']['verified']&&$_smarty_tpl->tpl_vars['cfg']->value['icons']['verified']) {?><div><img src="<?php echo $_smarty_tpl->tpl_vars['cfg']->value['icons']['verified'];?>
" class="verified_icon" alt="" /></div><?php }?>
									<?php if ($_smarty_tpl->tpl_vars['listing']->value['icons']['buy_now']&&$_smarty_tpl->tpl_vars['cfg']->value['icons']['buy_now']) {?><div><img src="<?php echo $_smarty_tpl->tpl_vars['cfg']->value['icons']['buy_now'];?>
" class="buy_now_icon" alt="" /></div><?php }?>
									<?php if ($_smarty_tpl->tpl_vars['listing']->value['icons']['reserve_met']&&$_smarty_tpl->tpl_vars['cfg']->value['icons']['reserve_met']) {?><div><img src="<?php echo $_smarty_tpl->tpl_vars['cfg']->value['icons']['reserve_met'];?>
" class="reserve_met_icon" alt="" /></div><?php }?>
									<?php if ($_smarty_tpl->tpl_vars['listing']->value['icons']['reserve_not_met']&&$_smarty_tpl->tpl_vars['cfg']->value['icons']['reserve_not_met']) {?><div><img src="<?php echo $_smarty_tpl->tpl_vars['cfg']->value['icons']['reserve_not_met'];?>
" class="reserve_not_met_icon" alt="" /></div><?php }?>
									<?php if ($_smarty_tpl->tpl_vars['listing']->value['icons']['no_reserve']&&$_smarty_tpl->tpl_vars['cfg']->value['icons']['no_reserve']) {?><div><img src="<?php echo $_smarty_tpl->tpl_vars['cfg']->value['icons']['no_reserve'];?>
" class="no_reserve_icon" alt="" /></div><?php }?>
									
									<?php if ($_smarty_tpl->tpl_vars['listing']->value['icons']['attention_getter']) {?><div><img src="<?php echo $_smarty_tpl->tpl_vars['listing']->value['attention_getter_url'];?>
" class="attention_getter_icon attention-getter-inline" alt="" /></div><?php }?>
...
?>
											<div><?php echo $_smarty_tpl->tpl_vars['icon']->value;?>
</div>
										<?php } ?>
									<?php }?>
								</div>
							<?php } elseif ($_smarty_tpl->tpl_vars['cfg']->value['cols']['icons']&&$_smarty_tpl->tpl_vars['listing']->value['icons']) {?>
								<?php if ($_smarty_tpl->tpl_vars['listing']->value['icons']['sold']&&$_smarty_tpl->tpl_vars['cfg']->value['icons']['sold']) {?><div><img src="<?php echo $_smarty_tpl->tpl_vars['cfg']->value['icons']['sold'];?>
" alt="" /></div><?php }?>
								<?php if ($_smarty_tpl->tpl_vars['listing']->value['icons']['verified']&&$_smarty_tpl->tpl_vars['cfg']->value['icons']['verified']) {?><div><img src="<?php echo $_smarty_tpl->tpl_vars['cfg']->value['icons']['verified'];?>
" class="verified_icon" alt="" /></div><?php }?>
								<?php if ($_smarty_tpl->tpl_vars['listing']->value['icons']['buy_now']&&$_smarty_tpl->tpl_vars['cfg']->value['icons']['buy_now']) {?><div><img src="<?php echo $_smarty_tpl->tpl_vars['cfg']->value['icons']['buy_now'];?>
...
" alt="" /></a>
				...
				<?php if ($_smarty_tpl->tpl_vars['gallery_columns']->value&&($_smarty_tpl->tpl_vars['listing']->iteration%$_smarty_tpl->tpl_vars['gallery_columns']->value==0||$_smarty_tpl->tpl_vars['listing']->last)) {?></div><?php }?>
			<?php } ?>
			<div class="clear"></div>
		</div>
		<div class="galleryScroll" style="display: none;">
			<img src="<?php echo smarty_function_external(array('file'=>'images/buttons/left_arrow.png'),$_smarty_tpl);?>
" alt="" class="leftScroll" />
			<img src="<?php echo smarty_function_external(array('file'=>'images/buttons/right_arrow.png'),$_smarty_tpl);?>
" alt="" class="rightScroll" />
		</div>
	</div>
<?php }?>
